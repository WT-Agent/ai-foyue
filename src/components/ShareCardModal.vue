    ...
    <div class="modal-content share-modal-content">
      ...
      <div id="share-card-node" class="share-card-wrapper">
        <div class="share-card-header">
          ...
          <span class="share-tag">每日佛曰解压</span>
        </div>
        ...
        <div class="share-card-footer">
          <div class="share-qrcode-area">
            ...
            <div class="share-tip-text">
              <span class="primary">扫码体验 AI 每日佛曰与功德木鱼</span>
...
// 清理回复末尾的特殊标记 [ZEN_SCORES]...[/ZEN_SCORES]
const cleanContent = computed(() => {
  if (!props.content) return '';
  return props.content.replace(/\[ZEN_SCORES\][\s\S]*?\[\/ZEN_SCORES\]/gi, '').trim();
});

const handleCopy = async () => {
  try {
    const textToCopy = `【网腾无限AI - 每日佛曰解惑】\n\n${cleanContent.value}\n\n体验每日木鱼与数字解压：https://ai.wuxian.xyz`;
